...
def rrf(runs: list[list[list[tuple[str, float]]]], k: int = 60, depth: int = 100) -> list[list[tuple[str, float]]]:
    """Reciprocal rank fusion of several ranked runs (same query order)."""
    fused = []
